...
public class OpenApiConfig {
    ...
    public OpenAPI baseOpenAPI() {
        ...
        return new OpenAPI().components(components).info(new Info().title("Project Management System Docs").version("1.0.0").description("This is Swagger API documentation using Spring Boot"));
    }
}
